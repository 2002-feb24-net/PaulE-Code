                ...
                else if (input == "s")
                {
                    ...
                    try
                    {
                        using (var context = new ReviewsContext())
                        {
                            ...
                            {
                                var newRestaurant = new List<Restaurant>();
                                var myNewRestraunt = new Restaurant
                                {
                                    Name = "Paul's Place",
                                    Id = 69
                                };
                                newRestaurant.Add(myNewRestraunt);
                            ...
                            var myLoad = context.Restaurants.First((p) => p.Contains());

                            Console.WriteLine(myLoad.Name);
